...
def Step3A_HPC_Get_PerMonthData_withCleanCodes(user_name, path_input, path_output, mecareClaims, mecaidClaims, mecaidClaims2, drug_code):
    ...
    for i in range(len(analysis_ID)): #len(analysis_ID)
        ...
        elif not cleaned_medicaid_health_df.empty and cleaned_medicaid_pharm_df.empty and cleaned_medicare_df.empty:
        ...
        for k in range(len(start_date)): #
            ...
            curr_unique_ICD_PROC  = get_uniquecodes_perMonth("PROC_ICD",curr_month_df1_Health,curr_month_df2,[],ICD_procedure_cols2)
            ...
            curr_unique_AHFS_DRUG = get_uniquecodes_perMonth("DRUG_AHFS",curr_month_df1_Pharm,curr_month_df2,AHFS_drug_cols1,[])
